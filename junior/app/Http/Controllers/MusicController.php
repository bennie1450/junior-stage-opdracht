...
class MusicController extends Controller
{
    ...
    public function getList(){
        ...
        return view('music.list')->with(compact('song', 'song2', 'song3','song4','song5','song6','song7','song8','song9','song10', 'music'));
    ...
    public function getDetail()
    {
        ...
        return view('music.detail')->with(compact('song', 'song2', 'song3','song4','song5','song6','song7','song8','song9','song10'));
    }
}
